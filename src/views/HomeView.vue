        ...
        <div class="flex flex-row">
            ...
            <div class="grid grid-cols-3 gap-3 overflow-hidden md:w-3/4 md:grid-cols-3 lg:grid-cols-4 min-w-min xs:grid-cols-1 auto-cols-min auto-rows-min">
                ...
                >
                    ...
                    <div class="flex flex-row flex-wrap items-center justify-between m-0.5">
                        <div
                        class="flex gap-2 p-1 border rounded-lg">
            ...
            <div class="fixed hidden right-5 md:w-1/5 h-fit md:flex md:flex-col">
                ...
                <div class="p-2 border-4 border-white rounded-lg md:shadow-xl">
                    <div class="flex flex-col items-center gap-5 p-4" v-if="quickViewData.length < 1">
                        <p class="text-lg font-light">Hover on a card to see full details</p>
                        <img :src="HoverImage" alt="hover image" class="w-[200px] h-[200px]">
                    </div>
                    ...
                    <div class="flex flex-col gap-2.5 p-2" v-else>
                        ...
                        <p class="flex gap-2 font-light">
                            Categories:
                            <span class="flex gap-2" v-for="category in quickViewData.categories">
